...
// 1- pendulum ([6, 6, 8 ,5 ,10]) ==> [10, 6, 5, 6, 8]
...
// 3- pendulum ([11, -16, -18, 13, -11, -12, 3, 18 ]) ==> [13, 3, -12, -18, -16, -11, 11, 18]
...
function pendulum(values) {
        ...
        for (let i = 0; i < sortedArray.length; i += 1) {
                if (i % 2 === 0) {
                        leftAndRight.left.push(sortedArray[i]);
                } else {
                        leftAndRight.right.push(sortedArray[i]);
                }
        }
        return leftAndRight.left.reverse().concat(leftAndRight.right);
}
